        ...
        <div className="flex gap-3">
          {project.links.map(link => (
            <a
              ...
              className="text-[10px] inline-flex items-center gap-2 rounded-md bg-gray-900 px-2 py-1 text-sm font-medium text-white transition-colors hover:bg-gray-800 dark:bg-white dark:text-black dark:hover:bg-white/90"
            >
              {link.type === "website" ? (
                <>
